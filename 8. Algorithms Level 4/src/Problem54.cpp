...
namespace Problem54 {
	...
	void main() {
		...
		cout << "\nVacation Ends: "; sDate DateTo = ReadDateInfo();

		cout << "\nVaction From: " << DayShortName(DayOfWeekOrder(DateFrom)) << " , " << DateAsString(DateFrom) << endl;
		cout << "Vaction To: "     << DayShortName(DayOfWeekOrder(DateTo))   << " , " << DateAsString(DateTo)   << endl;
